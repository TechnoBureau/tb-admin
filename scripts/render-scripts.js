...
module.exports = function renderScripts() {
    ...
    const sourcePathScriptsJS = upath.resolve(upath.dirname(__filename), '../src/js/tb-admin.js');
    const destPathScriptsJS = upath.resolve(upath.dirname(__filename), '../dist/js/tb-admin.js');
